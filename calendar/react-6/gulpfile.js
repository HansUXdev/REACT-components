...
gulp.task('settings', function() {
  octophant('app/styles/components/**/*.scss', {
    title: 'Component Settings',
    output: 'app/styles/_settings.scss'
    //,
...
gulp.task('bundle', ['html', 'styles', 'settings', 'scripts', 'images', 'fonts', 'extras']);
...
gulp.task('watch', sync(['clean-bundle', 'serve']), function() {
  ...
  gulp.watch('app/styles/**/*.scss', ['styles','settings']);
